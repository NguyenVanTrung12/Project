                        ...
                        <nav className="navbar navbar-expand-lg" style={{ padding: 0 }}>
                            ...
                            <div className={`collapse navbar-collapse list ${isMenuOpen ? 'show' : ''}`} id="navbarSupportedContent">
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item dropdown">
                                    <a href="/store" className="nav-link " role="button" data-bs-toggle="dropdowns" aria-expanded="false">
                                            Store
                                        </a>
                                    ...
                                    <li className="nav-item">
                                        <Link to="/FAQs" className="nav-link" aria-disabled="true" style={{textTransform: 'none'}}>FAQs</Link>
                                    </li>
                                    <li className="nav-item">
