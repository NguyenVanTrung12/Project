        ...
        <div className="container-fluid introduce">
            ...
            <nav className="breadcrumb">
                ...
                <div className="row">
                    ...
                    {/* Right Column */}
                    <div className="col-xs-12 col-sm-12 col-md-12 col-lg-4 rightt">
                        <img src="./img/g31.jpg" alt="Article Image" className='imgg'  style={{ borderRadius: '10px' ,width:'100%' }} />
