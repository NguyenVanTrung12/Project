...
export default function Store({ addToCart, limit, title, cat }) {
    const menu1 = data.categories;
    const menu2 = data.Gymaccessories;
    const productsAll = data.product;


    const [products, setProducts] = useState(productsAll.slice(0, 33));
                ...
                <div class="row">
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                        ...
                        <div class="left-sidebar" >
                            <div class="brands_products" style={{ marginTop: 100 }}>
                                <h2>Categories</h2>
                                                    ...
                                                    <div class="product-image-wrapper">
                                                        <div class="single-products">
                                                            <div class="productinfo text-center">
                                                                ...
                                                                <Link to={`/ProductDetails/${item.id}`} style={{ textDecoration: 'none' }}><p>{item.name.slice(0, 50) + '...'}</p> </Link>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="image-parent">
                                <img style={{ width: '100%', marginTop: 100 }} src="img/banner2" alt="" srcset="" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0">
                        <Accordion.Header>  + Which gym equipment is the most popular in 2024?</Accordion.Header>
                        <Accordion.Body>
                    ...
                    <Accordion.Item eventKey="1">
                        <Accordion.Header style={{ marginTop: 50 }}>  +   How to classify gym equipment and tools?</Accordion.Header>
                        <Accordion.Body >
